...
bot = telebot.TeleBot('7725804244:AAFVl1dq93ni7DsJ0n00OT9UO2YgenfsysQ')
...
def create_random_key(length=10):
    ...
    custom_key = f"Royal-VIP-{random_key.upper()}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𑁍┊ROYAL 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)
